...
undum.game.situations = {
    start: new undum.SimpleSituation(
            ...
            <p class='transient'><a href='hub'>Continuar...</a></p>",
            {
                exit: function (character, system, from) {
                    system.write("<p> Pero lo primero es lo primero, &iquest;qu&eacute; tal si te das una peque&ntilde;a vuelta por la academia?\
                        Seguro que te viene de maravilla para no perderte luego.\
                        &iexcl;Cuando termines de explorar recuerda pasarte por el Hall Principal! \
                        El mism&iacute;simo director en persona dar&aacute; una primera charla sobre la formaci&oacute;n de los equipos \
                ...
                actions: {
                    'que-es-un-grimm': "<p> <h1>Grimms</h1>\
                        ...
                        &iquest;Terror&iacute;fico verdad? &iexcl;Por eso debes entrenarte! Para plantar cara a aquellos que osen poner en peligro a\
            ...
            "<p class='transient'><a href='puerta'>Intentar abrir la puerta</a>  || <a href='hub'>Darse la vuelta y explorar</a>.</p>",
            {
                ...
                enter: function (character, system, from) {
                    if (character.qualities.puertaabierta) {
                        ...
                        system.write("<p> Eliges ir a visitar tu dormitorio, despu&eacute;s de un \
                            largo viaje lo mejor es dejar el equipaje y descansar.\
                            Tras deambular por los diferentes pasillos, perderte\
                            varias veces y entrar a la habitaci&oacute;n equivocada en\
                            alguna que otra ocasi&oacute;n, consigues llegar a la tuya.\
                            </p>\
    ...
    "puertaabierta": new undum.SimpleSituation(
            ...
            <p>Vuelves a tu habitaci&oacute;n, piensas que quiz&aacute;s deber&iacute;as de investigar un poco m&aacute;s antes de ir hacia el hall principal.\n\
    ...
    "abrir": new undum.SimpleSituation(
            ...
            <p>No es... lo que ten&iacute;as en mente precisamente.\
            Unas literas improvisadas de mala manera se alzan ante ti, con dificultades, pero se alzan.\
            La primera est&aacute; sujeta por varias cuerdas, y la segunda est&aacute; separada de la inferior por unas\
            cuantas pilas de libros a modo de soporte. Eso s&iacute;, al menos estaba medianamente limpia.\
            Dejas tu equipaje, y te tumbas unos segundos en la cama que tiene una etiqueta con tu nombre,\
            sin embargo notas algo duro e inc&oacute;modo debajo.\
            </p>\
    ...
    arma: new undum.SimpleSituation(
            ...
            Ahora tambi&eacute;n entend&iacute;as por qu&eacute; la puerta de tu dormitorio se hab&iacute;a mantenido cerrada bajo llave.</p>\
            \
    ...
    cocina: new undum.SimpleSituation(
        ...
        <p>Sin embargo, un peque&ntilde;o destello en la distancia llama tu atenci&oacute;n. \
        &iquest;Deber&iacute;as de <a href='mirardetalladamente'>mirar detalladamente</a> la estancia, \
        o ser&iacute;a mejor <a href='hub'>salir a explorar de nuevo?</a></p>\
        </p>",
            {
                heading: "La cocina",
                diplayOrder: 2,
    ...
    mirardetalladamente: new undum.SimpleSituation(
            "<p>Decides echar un mejor vistazo a aquel objeto que reluc&iacute;a, cercano a la encimera central de la cocina. </br> \
            Intentando esquivar la directa mirada de la cocinera, consigues acercarte sin\
            llamar demasiado la atenci&oacute;n, y visualizas una llave un tanto curiosa. Tan curiosa que... &iquest;quiz&aacute;s deber&iacute;as robarla? \
            No quer&iacute;as causar problemas nada m&aacute;s llegar pero...\
            la verdad es que tu sentido de la investigaci&oacute;n era una de tus cualidades que m&aacute;s puertas te hab&iacute;a abierto hasta el momento.</p>\
    ...
    progress: new undum.SimpleSituation(
        ...
        encontraba y un leve sentimiento de abrumaci&oacute;n se adentraba en tu cuerpo al sentirte \
        tan peque&ntilde;o frente al director, el p&uacute;blico y los dem&aacute;s cazadores de rangos m&aacute;s altos.\
        En cuanto el resto de la sala guard&oacute; silencio, el director, subido a un atril comenz&oacute; a hablar.\
        \
    ...
    "atacar": new undum.SimpleSituation(
            ...
            <p>Como era obvio, decidiste pasar y adentrarte, parec&iacute;a ser la cueva en la que hasta ahora hab&iacute;a estado viviendo aquel bicho.</p>\
                <p>A unos escasos pasos, encontraste un enorme cofre, que abriste sin duda alguna. \
                   Dentro de &eacute;ste hab&iacute;a un arma totalmente nueva y resplandeciente. \
...
Tras un no demasiado largo periodo de tiempo, llegaste a la entrada de otra cueva, esta era algo m&aacute;s grande y por el aspecto y las enormes huellas de la entrada, parec&iacute;a que era donde aquel Grimm hab&iacute;a estado habitando hasta ahora.\
    ...
    "gritar": new undum.SimpleSituation(
        ...
        <p>Al fondo del lugar pudiste apreciar la figura de Ruby, aquella compa&ntilde;era que te hab&iacute; sido asignada, decidiste saludarla desde lejos, alzando la mano y esperando que se acercase a saludarte y darte la enhorabuena por tus haza&ntilde;as. \
           Sin embargo, gir&oacute; la cara.</p>\
        <p>Otro compa&ntilde;ero se acerc&oacute; a hablar con ella y se marcharon camino a la sala de entrenamiento, se trataba de su nueva pareja de cazador. \
    ...
    "equipar-arma": new undum.SimpleSituation(
            "<h1>Equipar Arma</h1>\
        <p>No puedes resistirte a los encantos y los ojitos que el nuevo arma te hac&iacute;a. \
           Era fuerte, resplandeciente, parec&iacute;a efectiva y adem&aacute;s, aquellos engranajes parec&iacute;an encarnar un misterio que te apetec&iacute;a investigar y resolver. \
        </p>\
    ...
    "punto-extraccion": new undum.SimpleSituation(
            "<p>Tras unas horas de vuelta, consigues llegar al punto de extracci&oacute;n. \
                Env&iacute;as una peque&ntilde;a se&ntilde;al desde el dispositivo localizador que todo estudiante de cazador pose&iacute;a, y vuelves de vuelta a la academia en aquella extra&ntilde;a nave. \
             ...
             <p>Al fondo del lugar pudiste apreciar la figura de Ruby, aquella compa&ntilde;era que te hab&iacutea; sido asignada, decidiste saludarla desde lejos, alzando la mano y esperando que se acercase a saludarte y darte la enhorabuena por tus haza&ntilde;as. \
                Sin embargo, gir&oacute; la cara.</p>\
             <p>Otro compa&ntilde;ero se acerc&oacute; a hablar con ella y se marcharon camino a la sala de entrenamiento, se trataba de su nueva pareja de cazador. \
                Haberla dejado tirada quiz&aacute;s no fue la mejor de las opciones, sin embargo, ahora ten&iacute;s otras cosas de las que preocuparte, como tu preparaci&oacute;n para las misiones de segundo grado a las que te tocar&iacutea; enfrentarte a partir de ahora.</p>\
    ...
    "siguiente": new undum.SimpleSituation(
            "<p>Ahora s&iacute;, tu real y primer d&iacute;a en la academia estaba por comenzar. \
                Saludaste a Ruby nada m&aacute;s despertar, ambos hab&iacute;ais pasado una noche algo tenebrosa con miedo a que aquellas literas mal colocadas se os pudieran estampar en la frente en cualquier momento, pero al menos eso os di&oacute; algo de lo que hablar durante esa ma&ntilde;ana y sobre lo que re&iacute;ros un buen rato. \
                La hiperactividad de Ruby segu&iacute;a siendo ciertamente llamativa, pero eso tambi&eacute;n hac&iacute;a que tu d&iacute;a se llenase de algo de energ&iacute;a. \
             ...
             <br><p>Poco despu&eacute;s procedisteis a la sala de entrenamiento, donde junto otros equipos y parejas comenzasteis a entrenar y desarrollar vuestras habilidades con distintas armas, piruetas y t&eacute;nicas que podr&iacute;an resultar bastante &uacute;iles de cara a un combate contra un Grimm. \
             ...
             <p>Conforme los d&iacute;as pasaban, la relaci&oacute;n entre tu compa&ntilde;era y t&uacute; iba estrechando lazos. \
                ...
                Compart&iacute;ais as&iacute; vuestro tiempo libre, hablab&aacute;is de vuestras familias, vuestros problemas, vuestras inquietudes, a qu&eacute; os querr&iacute;ais dedicar cuando salierais de all&iacute;. \
                Casi todas las parejas quer&iacute;an entrenar con vosotros pues, al llevaros tan bien, vuestra sinergia en el campo de batalla era destacable por encima de la de los dem&aacute;s. </p> \
             ...
             <p><i>Es por ello que quiero ofrecerte lo siguiente, la oportunidad de ascender desde ya mismo al siguiente rango de cazador. \
                   &iquest;Qu&eacute; conseguir&iacute;s con esto? Optar a un entrenamiento m&aacute;s especializado en tu categor&iacute;a, con un tipo determinado de arma y con un cazador superior observando de cerca tu mejor&iacute;a. \
                   Adem&aacute;s podr&iacute;as asistir a misiones m&aacute;s importantes y con mejores recompensas y agilizar&iacute;as bastante tu progreso.</i></p>\
              <br><p><i>Por el contrario tendr&iacute;as que dejar tanto a tu compa&ntilde;era como a tu futuro equipo de lado y cuando digo de lado es que raramente podr&aacute;s volver a verlos. S&eacute; que ahora mismo vuestros lazos y amistad es muy fuerte, pero ni siquiera estar&eacute;is en el mismo edificio y ni mucho menos habitaci&oacute;n, y la mayor&iacute;a de informaci&oacute;n que obtendr&aacute;s ser&aacute; lo suficientemente confidencial como para no transmitirla a cazadores de menor rango esto es te ser&aacute; casi imposible mantener una amistad con ellos. \
